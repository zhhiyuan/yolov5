...
allimgs = glob.glob('Safe_helmet/train/' + "/*.jpg")
...
for i in img_list_val:
    ...
    # xml
    shutil.copy('Safe_helmet/label/' + 'new_' + img_id + '.xml', label_val + img_id + '.xml')
...
for i in img_list_train:
    ...
    # xml
    shutil.copy('Safe_helmet/label/' + 'new_' + img_id + '.xml', label_train + img_id + '.xml')
